const questions = [
    ...
    },
    {
        ...
        "w określone pola wzorca, umożliwiające ich wprowadzenie",
            "postanowienia umowy spółki zawartej pisemnie lub przy wykorzystaniu wzorcą\n" +
            "umowy, które zgodnie z wzorcem mogą być modyfikowane przez wybór odpowied.\n" +
            "nich wariantów poszczególnych postanowień albo przez wprowadzenie odpowiednich danych w określone pola wzorca, umożliwiające ich wprowadzenie",
